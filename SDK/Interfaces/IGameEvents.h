...
public:
	...
	virtual unsigned long   _GetUint64(const char* keyName = nullptr, unsigned long defaultValue = 0) = 0;
	...
	void SetString(const char* keyName, const char* value)
	{
		...
		CallVFunction<OriginalFn>(this, 16)(this, keyName, value);
	}
};
...
public:
	...
	virtual IGameEvent* _CreateEvent(const char* name, bool bForce, unsigned int dwUnknown) = 0;
