...
namespace ImGui
{
    ...
    IMGUI_API void          Keybindbox(const char* label, const char* hint, bool* v, int* key, int* mode);
    IMGUI_API void          TooltipBind(const char* label, const char* hint, int* key, int* mode);
