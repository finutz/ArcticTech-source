...
//#endif
    ...
    IMGUI_API bool          Tab(bool selected, ImTextureID image, const char* label, const ImVec2& size_arg, const ImVec2& image_size, ImGuiButtonFlags flags = 0);
    ...
    IMGUI_API bool          Keybind(const char* label, int* key, int* mode, bool show_label = true);
